...
pthread_mutex_t pause_pressed_mutex		= PTHREAD_MUTEX_INITIALIZER;
pthread_mutex_t pause_released_mutex	= PTHREAD_MUTEX_INITIALIZER;
pthread_mutex_t mode_pressed_mutex		= PTHREAD_MUTEX_INITIALIZER;
pthread_mutex_t mode_released_mutex		= PTHREAD_MUTEX_INITIALIZER;
pthread_cond_t pause_pressed_condition	= PTHREAD_COND_INITIALIZER;
pthread_cond_t pause_released_condition	= PTHREAD_COND_INITIALIZER;
pthread_cond_t mode_pressed_condition	= PTHREAD_COND_INITIALIZER;
pthread_cond_t mode_released_condition	= PTHREAD_COND_INITIALIZER;
...
int rc_wait_for_pause_press(){
	...
	if(!buttons_en){
		fprintf(stderr,"ERROR: call to rc_wait_for_pause_press() when buttons are not enabled.\n");
		return -2;
	}
